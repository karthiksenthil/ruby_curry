...
# TODO: why the stack is in this file ???
...
#p class Partial < Expression
#p   attr_accessor :missing, :expression
#p   def initialize(missing,expression)
#p     @missing = missing
#p     @expression = expression
#p   end
#p   def show
#p     sprintf("Partial(%d,%s)", missing, expression.show)
#p   end
#p end
