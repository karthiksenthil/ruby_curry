module CT_Symbols
  ...
  class Variable < XSymbol
    @@counter = 0

    # The identifiers of free variables are managed internally,
    # autogenerated, since the original ones are lost in Flatcurry
    def initialize
      @@counter += 1
    ...
    # free variables start with an underscore
    def conv_ruby_var
      return @name
    end
